...
import { ProfilePasswordModal } from "@/app/components/ProfilePasswordModal";
...
export function ProfileContent({ id }: ProfileContentProps) {
  ...
  return (
    <div className="min-h-screen pb-20 animate-fade-in bg-slate-50">
          ...
          <div className="max-w-xl mx-auto relative">
            ...
            <div className="relative bg-white rounded-2xl shadow-lg">
              ...
              <button
                ...
                title="Edit profile"
              >
                <Icon name="lucide:pencil" size={16} className="text-slate-600" />
              </button>
      ...
      {/* Password Modal */}
      {showPasswordModal && hasPassword !== undefined && (
        <ProfilePasswordModal
          ...
          onSuccess={(password) => {
            ...
            // Store password in sessionStorage for the edit page
            if (password) {
              sessionStorage.setItem(`edit-password-${id}`, password);
            }
